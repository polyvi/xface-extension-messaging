...
describe("Message", function () {
    it("messaging.spec.1 should exist", function() {
        expect(xFace.Messaging).toBeDefined();

    });

    it("messaging.spec.2 should define constants for Message Types", function() {
    ...
    it("messaging.spec.3 should contain a createMessage function", function() {
    ...
    describe("createMessage method", function() {
        it("messaging.spec.4 success callback should be called with a message", function() {
    ...
    describe("createMessage method with unknown type", function() {
        it("messaging.spec.5 fail callback should be called", function() {
            var win = jasmine.createSpy().andCallFake(function(message) {
                    expect(message).toBeDefined();
                    expect(message.subject).toBeDefined();
                    expect(message.body).toBeDefined();
    ...
    if (isAndroid()) {
        it("messaging.spec.6 should define constants for MessageFolder Types", function() {
            expect(xFace.MessageTypes).toBeDefined();
        ...
        it("messaging.spec.7 should contain a getMessage  function", function() {
        ...
        describe("getMessage method", function() {
            it("messaging.spec.8 success callback should be called with a message", function() {
                var win = jasmine.createSpy().andCallFake(function(message) {
                        expect(message).toBeDefined();
                        expect(message.subject).toBeDefined();
                        expect(message.body).toBeDefined();
        ...
        it("messaging.spec.9 should contain a getAllMessages function", function() {
        ...
        describe("getAllMessages method", function() {
            it("messaging.spec.10 success callback should be called with a message array", function() {
        ...
        it("messaging.spec.11 should contain a getQuantities function", function() {
            expect(xFace.Messaging.getMessage).toBeDefined();
            expect(typeof xFace.Messaging.getMessage  == 'function').toBe(true);
        });

        describe("getQuantities method", function() {
            it("messaging.spec.12 success callback should be called with a num", function() {
        ...
        describe("findMessage method", function() {
            it("messaging.spec.13 success callback should be called with a message array", function() {
                var win = jasmine.createSpy().andCallFake(function(messages) {
                        expect(messages).toBeDefined();
                        expect(messages.length >= 0).toBe(true);
                    }),
